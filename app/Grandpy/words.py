stopwords = ["a","abord","absolument","afin","ah","ai","aie","ailleurs","ainsi",
...
"b","bah","bas","basee","bat","beau","beaucoup","bien","bigre","boum","bravo",
...
"merci","mes","mien","mienne","miennes","miens","mille","mince","minimale",
"moi","moi-meme","moi-même","moindres","moins","mon","moyennant","multiple",
...
"precisement","premier","première","premièrement","pres","probable","probante",
"procedant","proche","près","psitt","pu","puis","puisque","pur","pure","q",
"qu","quand","quant","quant-à-soi","quanta","quarante","quatorze","quatre",
